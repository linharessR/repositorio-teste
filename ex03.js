const faturamentoMensal = [
  ...
  function calcularFaturamento(faturamentoMensal) {
    // Filtrando os dias com valor > 0 para calcular a média
    const diasComFaturamento = faturamentoMensal.filter(f => f.valor > 0);
    ...
    const somaFaturamento = diasComFaturamento.reduce((acc, f) => acc + f.valor, 0);
